...
export default function Home() {
  return <main>
    ...
    <section id="top" className="hero"><p className="eyebrow">Private freelance milestones and creator subscriptions</p><h1>Private compute.<br /><em>Verifiable outcomes.</em></h1><p className="lede">Gigstark uses ZK proofs for enforceable STRK20 settlement and optional Oyster attestations for independently verifiable execution receipts. Helper amounts and timing are not cryptographically hidden.</p><div className="hero-actions"><a className="button" href="#compute">See the compute path</a><span>Non-custodial · no Athera L1/L3 · onchain deployment gated</span></div></section>
    <ReleaseStatus />
